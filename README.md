...
**社区共建 + 官方持续上新**。从「三千AI操盘手」到「复制爆款视频」,智能体广场不断添加新能力,用户开箱即用。

- 🤖 **三千AI操盘手** —— AI 内容创作全流程助手:IP 诊断 → 选题 → 脚本生成
- 🎬 **复制爆款视频** —— 粘贴抖音 / TikTok 视频链接,自动改写文案并生成新视频
- 🛠️ **工具智能体** —— 输入素材,自动完成一整套生成任务
- ✨ **持续上新中** —— 短视频、爆款、电商、口播…新智能体陆续接入

![智能体广场](./screenshots/13-admin-agent.png)
...
| 维度 | 能力 |
|---|---|
| 📡 **数据源** | 抖音热搜 · 微博热搜榜 · B 站热搜 · 快手热榜 · 小红书热榜 · 视频号(持续接入)|
