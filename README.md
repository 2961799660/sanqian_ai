...
### 4️⃣ 社媒数据 · 全网热点(NEW v25.3.6)

**选题不愁** —— 一屏看完抖音/微博/B站/快手/小红书/视频号 6 个平台的实时热搜,**每整点小时自动刷新**。

| 维度 | 能力 |
|---|---|
| 📡 **数据源** | 抖音热搜 · 微博热搜榜 · B 站热搜 · 快手热榜 · 小红书热榜 · 视频号热门话题(开发中) |
| ⏱️ **更新频率** | 每整点小时自动 cron 拉取 + 可手动刷新 |
| 🎯 **选题闭环** | 工作台顶部「现在大家在聊」teaser 一行展示 → 进入完整热点列表 |
| 📋 **一键复制** | 单条热搜直接复制标题到剪贴板,粘到 IP 文案工坊立即出脚本 |
| 🔑 **后台密钥配置** | TikHub API Key 在「后台 - 密钥配置」可视化管理,5 分钟内生效,无需改 .env |

**视觉**:报刊式浅色反差(米白底 + 高对比黑字 + 暖琥珀点缀),反 AI 味设计,信息密度高。

![社媒数据热点列表](./screenshots/21-social-trending.png)
