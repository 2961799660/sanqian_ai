...
> **加盟费回本**:初级代理卖 **8 单包搭建** 或 **3 单开源源码** 即可回本;中级代理卖 **8 单包搭建** 或 **3 单开源源码** 即可回本。

### 代理共同权益

- ✅ 加盟立即获得 **1 份授权**(价值 ¥2280,可自用 / 自建演示站给客户看)
...
**Q:做代理需要什么条件?**
不需要技术背景。只需对自媒体 / AI 工具 / 私域获客有自己的渠道资源。初级代理(¥8900)加盟即送 1 份授权(可自建演示站给客户看),卖 3 单源码即可回本。
