...
适合想自己当老板做拓展、开城市代理、做矩阵分销的团队。**三级代理体系,加盟即享代理价 + 销售提成**。

### 三级代理加盟

| 等级 | 加盟费 | 拿货价(对零售折扣) | 卖一单提成示例 |
|---|---|---|---|
| 🥇 **1 级代理(总代)** | **¥8900** | 5 折 | 授权 提 **¥1140** / 包搭建 提 **¥1990** / 开源源码 提 **¥6900** |
| 🥈 **2 级代理(区域代理)** | **¥4980** | 6.5 折 | 授权 提 **¥800** / 包搭建 提 **¥1393** / 开源源码 提 **¥4830** |
| 🥉 **3 级代理(推广员)** | **¥2980** | 7.5 折 | 授权 提 **¥570** / 包搭建 提 **¥995** / 开源源码 提 **¥3450** |

> **提成 = 零售价 − 拿货价**。代理可自定义零售价,不低于厂商指导价(¥2280 / ¥3980 / ¥13800)。
> **加盟费回本**:1 级代理只需卖出 **5 单授权** 或 **3 单包搭建** 或 **2 单源码** 即可回本。
...
**Q:做代理需要什么条件?**
不需要技术背景。只需对自媒体 / AI 工具 / 私域获客有自己的渠道资源。1 级代理(¥8900)送 1 份开源源码,卖 5 单授权即回本。

**Q:代理可以发展下级吗?**
可以。1 级代理可发展 2/3 级代理,**级差提成自动结算**。比如 1 级发展的 2 级代理成单,1 级也能拿到对应级差。
