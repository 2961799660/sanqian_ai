...
| 智能体 | 能力 | 标签 |
|---|---|---|
| 🎬 **智能视频** | 接入**火山小云雀 v2.0 + Seedance 2.0**(字节顶级模型) · 一句话出 9:16 短视频 / AI **漫剧** / 动漫二次元 · 覆盖 16 大领域(漫剧 / 动漫 / 二次元 / 教育 / 口播 / 美食 / 旅行 / 亲子 / 萌宠 / 知识 / 健身 / 时尚 / 节日 / 治愈 / 数码 / Vlog) · 双模式(纯文字纯创意 / 上传参考仿风格) | `AI 视频` `漫剧` |
| 🎞️ **故事工坊**(v1.0.5 新增) | **一句话生成 75 秒带配音的微动画** —— 6 段视频 + 旁白 + 字幕一键合成 | `故事` `微动画` |

![智能视频深度页](../screenshots/banners/11-smart-video.jpg)

##### 🎭 AI 漫剧 — 字节系 1.2 亿用户在追的赛道

「漫剧」是 2026 年最热的内容形态:**一年播放破 10 亿、市场规模超 200 亿**,字节即梦/小云雀 v2.0 原生支持。本系统底层模型直通,可一键产出:
...
| 档位 | 价格 | 说明 |
|---|---|---|
| **授权** | ~~¥2980~~ **¥2380**(限时优惠) | 仅授权,不含源码,用你自己的服务器部署发行包,官方持续更新 |
| **包搭建** | **¥3980** | 授权 + 代为搭建上线 |
